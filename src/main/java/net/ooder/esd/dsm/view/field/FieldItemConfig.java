...
public class FieldItemConfig implements ESDFieldConfig {
    ...
    public FieldItemConfig() {

    }

    public FieldItemConfig(ESDField info, String sourceClassName) {

...
public class GroupViewRoot extends BaseViewRoot<CustomGroupFormViewBean> {
    ...
    public GroupViewRoot(AggViewRoot viewRoot, CustomGroupFormViewBean viewBean, ModuleComponent moduleComponent, String moduleName, String className) {
        ...
        try {
            ...
            if (domainInst != null && domainInst.getUserSpace().equals(UserSpace.FORM)) {
                if (viewBean.getMethodConfig() != null && viewBean.getMethodConfig().getMethod() != null && viewBean.getViewClassName() != null) {
                    ...
                    FieldFormConfig fieldInfo = (FieldFormConfig) viewBean.getFieldByName(formTitleName);
                    if (fieldInfo == null) {
                        try {

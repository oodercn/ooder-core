...
public class SVGViewRoot extends BaseFormViewRoot<CustomSVGPaperViewBean> {
    ...
    public SVGViewRoot(AggViewRoot aggViewRoot, CustomSVGPaperViewBean viewBean, String moduleName, String className) {

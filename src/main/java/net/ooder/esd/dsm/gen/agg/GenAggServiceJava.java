...
public class GenAggServiceJava extends BaseAggCallabel {
    ...
    public GenAggServiceJava(DomainInst domainInst, AggEntityConfig esdClassConfig, Set<String> allTemps, ChromeProxy chrome) {
        super();

...
public class AggMenuRoot implements JavaRoot {
    ...
    public AggMenuRoot(DomainInst dsmBean, AggEntityConfig config, List<AggEntityRef> dsmRefs) {
        ...
        try {
            ...
            for (String javaTempId : javaTempIds) {
                ...
                if (javaTemp != null && javaTemp.getAggregationType() != null && javaTemp.getAggregationType().equals(AggregationType.MENU)) {
                    for (String basePackage : basePackages) {

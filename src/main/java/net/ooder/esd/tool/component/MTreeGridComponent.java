...
public class MTreeGridComponent extends Component<GridProperties, GridEventEnum> implements DataComponent<List<Row> > {

    public MTreeGridComponent(String alias) {
        super(ComponentType.MTREEGRID, alias);
        this.setProperties(new GridProperties());

    }

    public MTreeGridComponent(String alias, GridProperties properties) {
        super(ComponentType.MTREEGRID, alias);
        this.setProperties(properties);
    }

    public MTreeGridComponent() {
        super(ComponentType.MTREEGRID);
        this.setProperties( new GridProperties());
    }

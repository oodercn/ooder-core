...
public class FullButtonViewsComponent extends CustomModuleComponent<CustomButtonViewsComponent> {
    ...
    public FullButtonViewsComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) {
        ...
        try {
            CustomButtonViewsComponent currComponent = new CustomButtonViewsComponent(euModule, methodConfig, valueMap);

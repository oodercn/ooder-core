...
public class CustomFoldingTabsComponent extends FoldingTabsComponent {
    public CustomFoldingTabsComponent(EUModule euModule, FieldFormConfig<CustomFoldingTabsFieldBean, ?> field, String target, Object value, Map<String, Object> valueMap) {
        super();
        try {
    ...
    public CustomFoldingTabsComponent(EUModule module, MethodConfig methodConfig, Map<String, ?> valueMap) {
        super();
        try {
    ...
    public CustomFoldingTabsComponent(NavFoldingTabsViewBean tabsViewBean, Map<String, Object> valueMap) {
        super();
        try {

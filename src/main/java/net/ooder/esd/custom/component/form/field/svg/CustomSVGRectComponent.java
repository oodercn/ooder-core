...
public class CustomSVGRectComponent extends SVGRectComponent {


    public CustomSVGRectComponent(EUModule euModule, FieldFormConfig<SVGRectBean, ?> field, String target, Object value, Map valueMap) {
        super(field.getId() + ComponentType.SVGPATH.getType());
        SVGRectBean svgPathBean = field.getWidgetConfig().clone();

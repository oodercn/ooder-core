...
public class CustomSVGCircleCombComponent extends SVGCircleCombComponent{


    public CustomSVGCircleCombComponent(EUModule euModule, FieldFormConfig<SVGCircleCombBean, ?> field, String target, Object value, Map valueMap)  {
        super(field.getId() );
        SVGCircleCombBean svgPathBean = field.getWidgetConfig().clone();

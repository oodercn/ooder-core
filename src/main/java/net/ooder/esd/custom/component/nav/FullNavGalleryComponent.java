...
public class FullNavGalleryComponent extends CustomModuleComponent<GalleryComponent> {


    @JSONField(serialize = false)
    private GalleryComponent galleryComponent;
    @JSONField(serialize = false)
    private CustomTabsComponent tabsComponent;
    @JSONField(serialize = false)
    ...
    public FullNavGalleryComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) throws ClassNotFoundException {
        ...
        tabsComponent = new CustomTabsComponent(navGalleryViewBean.getTabsViewBean(), valueMap);
        tabsComponent.getProperties().getItems().clear();
        ...
        showAction.updateArgs(tabsComponent.getAlias(), 4);
        tabsComponent.addAction(showAction);

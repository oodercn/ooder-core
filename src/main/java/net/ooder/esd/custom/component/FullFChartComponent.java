...
public class FullFChartComponent extends CustomModuleComponent<CustomFieldFChartComponent> {
    ...
    public FullFChartComponent() {
        super();
    }


    public FullFChartComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) {
    ...
    void init(MethodConfig methodConfig) throws JDSException {
        ...
        CustomFieldFChartComponent currComponent = new CustomFieldFChartComponent(euModule, methodConfig, valueMap);
    ...
    protected void fillFromAction(CustomFChartViewBean view, Component currComponent) {

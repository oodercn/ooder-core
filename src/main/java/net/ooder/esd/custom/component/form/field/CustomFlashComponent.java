...
public class CustomFlashComponent extends FlashComponent {


    public CustomFlashComponent(EUModule euModule, FieldFormConfig field, String target, Object value, Map valueMap) {
        super(field.getId());

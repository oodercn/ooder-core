...
public class FullPanelComponent<M extends CustomFieldPanelComponent> extends CustomModuleComponent<M> {
    ...
    public FullPanelComponent() {
        super();
    }

    public FullPanelComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) {
    ...
    void init(MethodConfig methodConfig) throws JDSException {
        ...
        CustomFieldPanelComponent currComponent = new CustomFieldPanelComponent(euModule, methodConfig, valueMap);
    ...
    void fillToolBar(CustomPanelFormViewBean view, Component currComponent) throws JDSException {

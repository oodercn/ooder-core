...
import net.ooder.esd.tool.component.SVGEllipseCombComponent;
...
public class CustomSVGEllipseCombComponent extends SVGEllipseCombComponent{


    public CustomSVGEllipseCombComponent(EUModule euModule, FieldFormConfig<SVGEllipseCombBean, ?> field, String target, Object value, Map valueMap) {
        super(field.getId());
        SVGEllipseCombBean svgPathBean = field.getWidgetConfig().clone();

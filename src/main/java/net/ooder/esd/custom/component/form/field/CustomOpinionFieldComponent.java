...
public class CustomOpinionFieldComponent extends OpinionComponent {
    ...
    public CustomOpinionFieldComponent(EUModule euModule, FieldFormConfig<CustomOpinionFieldBean, ?> field, String target, Object value, Map valueMap) {
        super(field.getFieldname());
        this.setAlias(field.getFieldname());
        CustomOpinionFieldBean fieldBean = field.getWidgetConfig();
        CustomListBean customListBean = fieldBean.getCustomListBean();
        OpinionProperties listProperties = new OpinionProperties(fieldBean);
        ...
        listProperties.setDesc(aggConfig.getCaption());
        listProperties.setCaption(aggConfig.getCaption());
        listProperties.setReadonly(aggConfig.getReadonly());
        listProperties.setDisabled(aggConfig.getDisabled());
        ...
        if (fieldBean.getListMenuBean() != null) {
            ...
            for (String key : keset) {
                ...
                listProperties.addItem(new OpinionItem(item));
            }
    ...
    private void lazyLoad(EUModule euModule, FieldFormConfig field, CustomOpinionFieldComponent listComponent, Class bindClass) {
        try {
            if (bindClass != null) {

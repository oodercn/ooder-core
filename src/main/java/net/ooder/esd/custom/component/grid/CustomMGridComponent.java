...
public class CustomMGridComponent extends CustomModuleComponent<MTreeGridComponent> {
    ...
    public CustomMGridComponent() {
        super();
    }

    public CustomMGridComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) {
        super(module, methodConfig, valueMap);
        this.layoutComponent = new BlockComponent(Dock.fill, methodConfig.getViewClass().getName() + ComponentType.BLOCK.name());
    }

    public void addChildNav(MTreeGridComponent currComponent) {
    ...
    protected void fillGridAction(CustomMGridViewBean viewBean, Component currComponent) {
        ...
        if (pageBarBean != null) {
            ...
            if (!pageBarBean.getHeight().equals("")) {
                ...
                divComponent.getProperties().setHeight("0em");
            }
            layoutComponent.addChildren(divComponent);
        }

        Set<CustomMGridEvent> customFormEvents = viewBean.getMevent();
        for (CustomMGridEvent eventType : customFormEvents) {
    ...
    //填充默认绑定动作
    protected void fillMenuAction(CustomMGridViewBean viewBean, Component currComponent) {
        try {
            if (viewBean != null) {
    ...
    public void fillRowCmd(CustomMGridViewBean viewBean, Component currComponent) {
    ...
    APICallerComponent[] genAPIComponent(MethodConfig methodConfig, Component ctxComponent) throws JDSException, ClassNotFoundException {
        MTreeGridComponent currComponent = this.getCurrComponent();
        ...
        if (delPath != null && !delPath.equals("")) {
            ...
            if (methodBean != null) {
                UrlPathData requestPathData = new UrlPathData(currComponent.getAlias(), RequestPathTypeEnum.TREEGRID, "");
        ...
        if (saveRowPath != null && !saveRowPath.equals("")) {
            ...
            if (methodBean != null) {
                UrlPathData requestPathData = new UrlPathData(currComponent.getAlias(), RequestPathTypeEnum.TREEGRIDROWVALUE, "");
        ...
        if (sortPath != null && !sortPath.equals("")) {
            ...
            if (methodBean != null) {
                ...
                UrlPathData requestPathData = new UrlPathData(currComponent.getAlias(), RequestPathTypeEnum.TREEGRIDROW, "");
                if (requestPathData != null) {
        ...
        if (dataUrl != null && !dataUrl.equals("")) {
            ...
            UrlPathData responsePathData = new UrlPathData(currComponent.getAlias(), ResponsePathTypeEnum.TREEGRID, "data");

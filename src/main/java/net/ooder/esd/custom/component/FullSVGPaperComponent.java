...
public class FullSVGPaperComponent extends CustomModuleComponent<CustomFieldSVGPaperComponent> {
    ...
    public FullSVGPaperComponent() {
        super();
    }


    public FullSVGPaperComponent(EUModule module, MethodConfig methodConfig, Map<String, Object> valueMap) {
    ...
    void init(MethodConfig methodConfig) throws JDSException {
        CustomSVGPaperViewBean viewBean = (CustomSVGPaperViewBean) methodConfig.getView();
        CustomSVGPaperDataBean dataBean = (CustomSVGPaperDataBean) methodConfig.getDataBean();
        if (dataBean != null) {
    ...
    protected void fillFromAction(CustomSVGPaperViewBean view, Component currComponent) {
    ...
    void fillToolBar(CustomSVGPaperViewBean view, Component currComponent) throws JDSException {
    ...
    APICallerComponent[] genAPIComponent(Component ctxComponent, Component mainComponent) throws JDSException {
        ...
        //装载保存事件
        if (reSetUrl != null && !reSetUrl.equals("")) {
            MethodConfig methodBean = methodAPIBean.getDataBean().getMethodEvent(CustomFormEvent.SAVE);
            if (methodBean != null) {
                APICallerComponent saveAPI = new APICallerComponent(methodBean);
        ...
        if (searchUrl != null && !searchUrl.equals("")) {
            ...
            if (methodBean != null) {
                ...
                // EUModule newmodule = ESDFacrory.getESDClient().getCustomModule(searchMethodBean.getUrl(), version.getVersionName(), valueMap);

...
public class CheckValidAction<K extends EventKey> extends Action<K> {
    Args args;

    public CheckValidAction(K eventKey) {
        super(eventKey);
        init();
    }

    public CheckValidAction(String src,K eventKey) {
        super(eventKey);
        init();
        this.setTarget(src);
    }

    public CheckValidAction(MethodConfig fieldMethodConfig, K eventKey) {
        super(eventKey);
        init();
        this.setDesc("校验表单");
        Args args = new Args();
    ...
    public CheckValidAction(TreeListItem item, K eventKey) {
        super(eventKey);
        init();

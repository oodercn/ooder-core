...
public class PopPageAction<K extends EventKey> extends Action<K> {
    Args args;

    public PopPageAction(K eventKey) {
        super(eventKey);
        init();
    }

    public PopPageAction(String src,K eventKey) {
        super(eventKey);
        init();
        this.setTarget(src);
    }

    public PopPageAction(MethodConfig fieldMethodConfig, K eventKey) {
        super(eventKey);
        init();
    ...
    public PopPageAction(TreeListItem item, K eventKey) {
        super(eventKey);
        init();

...
public class AnnBlockListItem extends UIItem {

    public FChartAnnType type;
    public String id;
    public Integer x;
    public Integer y;
    public Integer tox;
    ...
    public Integer fillalpha;
    public Integer fillratio;
    public Integer fillangle;
    ...
    public Integer leftnargin;
    public String bgcolor;
    public String rotatetext;
    public Integer wrapwidth;
    public Integer wrapheight;
    public Boolean wrap;
    public Integer radius;
    public Integer yradius;

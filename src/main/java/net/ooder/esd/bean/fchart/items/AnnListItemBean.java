...
import net.ooder.esd.annotation.fchart.ChartAnnAnnotation;
...
@AnnotationType(clazz = ChartAnnAnnotation.class)
public class AnnListItemBean<T extends FieldItemConfig> implements ContextMenuBar, Comparable<TabItemBean>, CustomBean {
    ...
    public AnnListItemBean() {

    }


    public AnnListItemBean(MethodConfig methodConfig, CustomFChartViewBean chartDataBean) {
        ...
        ChartAnnAnnotation rawDataItem = AnnotationUtil.getMethodAnnotation(methodConfig.getMethod(), ChartAnnAnnotation.class);
        if (rawDataItem != null) {
            fillData(rawDataItem);
        } else {
            AnnotationUtil.fillDefaultValue(ChartAnnAnnotation.class, this);
        }


    }

    public AnnListItemBean(Constructor constructor, CustomFChartViewBean chartDataBean) {
        ...
        ChartAnnAnnotation rawDataItem = AnnotationUtil.getConstructorAnnotation(constructor, ChartAnnAnnotation.class);
        if (rawDataItem != null) {
            fillData(rawDataItem);
        } else {
    ...
    public AnnListItemBean<T> fillData(ChartAnnAnnotation annotation) {

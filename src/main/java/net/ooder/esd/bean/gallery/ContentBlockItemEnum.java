...
public enum ContentBlockItemEnum implements IContentBlockItem, IconEnumstype {

    item1("item1", "spafont spa-icon-alignwh", "&gt;&gt; 更多", "1", "信息报送"),
    item2("item2", "bpmfont bpmVueFlyActivityOperation", "&gt;&gt; 更多", "21", "日常审批"),
    item3("item3", "bpmfont bpmhuiyitongzhi2", "&gt;&gt; 更多", "7", "会议通知"),
    item4("item4", "spafont spa-icon-c-timeinput", "&gt;&gt; 更多", "0", "请销假");
    ...
    ContentBlockItemEnum(String caption, String flagClass, String more, String msgnum, String title) {
        this.id = name();
    ...
    ContentBlockItemEnum(String caption, String imageClass) {
        this.id = name();
        this.type = name();
        this.caption = caption;

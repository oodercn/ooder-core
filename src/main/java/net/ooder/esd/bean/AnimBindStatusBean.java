...
import net.ooder.esd.annotation.AnimStatusAnnotation;
...
@AnnotationType(clazz = AnimStatusAnnotation.class)
public class AnimBindStatusBean implements CustomBean {
    String left;
    String top;
    String width;
    String height;
    ...
    public AnimBindStatusBean() {

    }

    public AnimBindStatusBean(AnimStatusAnnotation annotation) {
        this.fillData(annotation);
    }

    public AnimBindStatusBean fillData(AnimStatusAnnotation annotation) {

...
@AnnotationType(clazz = GridAnnotation.class)
public class CustomGridViewBean extends CustomViewBean<FieldGridConfig, UIItem, TreeGridComponent> implements ContextMenuBar, ToolsBar {
    ...
    public CustomGridViewBean(ModuleComponent<TreeGridComponent> moduleComponent) {
        super();
    ...
    public CustomGridViewBean(MethodConfig methodAPIBean) {
        super(methodAPIBean);
        ...
        GridAnnotation annotation = AnnotationUtil.getClassAnnotation(clazz, GridAnnotation.class);
        if (annotation != null) {
            fillData(annotation);
        } else {
            AnnotationUtil.fillDefaultValue(GridAnnotation.class, this);
        ...
        GridRowCmd cmdannotation = AnnotationUtil.getClassAnnotation(clazz, GridRowCmd.class);
        if (cmdannotation != null) {
            rowCmdBean = new GridRowCmdBean(cmdannotation);
        }

        RowHead head = AnnotationUtil.getClassAnnotation(clazz, RowHead.class);
        if (head != null) {
    ...
    public List<CustomBean> getAnnotationBeans() {
        ...
        if (rowHead != null && !AnnotationUtil.getAnnotationMap(rowHead).isEmpty()) {
    ...
    public Set<Class> getOtherClass() {
        ...
        for (FieldGridConfig fieldGridConfig : this.getAllFields()) {
    ...
    public CustomGridViewBean fillData(GridAnnotation annotation) {

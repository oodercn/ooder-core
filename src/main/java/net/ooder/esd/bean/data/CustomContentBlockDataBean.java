...
import net.ooder.esd.annotation.view.ContentBlockViewAnnotation;
import net.ooder.esd.annotation.ui.ModuleViewType;
import net.ooder.esd.bean.MethodConfig;
import net.ooder.annotation.AnnotationType;
import net.ooder.esd.custom.component.FullContentBlockComponent;
import net.ooder.web.util.AnnotationUtil;
@CustomClass(
        clazz = FullContentBlockComponent.class,
        viewType = CustomViewType.LISTMODULE,
        moduleType = ModuleViewType.CONTENTBLOCKCONFIG
)
@AnnotationType(clazz = ContentBlockViewAnnotation.class)
public class CustomContentBlockDataBean extends CustomDataBean {
    ...
    public CustomContentBlockDataBean() {

    }


    public CustomContentBlockDataBean fillData(ContentBlockViewAnnotation annotation) {
        return AnnotationUtil.fillBean(annotation, this);
    }

    public CustomContentBlockDataBean(MethodConfig methodConfig) {
        super(methodConfig);
        ContentBlockViewAnnotation gridAnnotation = AnnotationUtil.getMethodAnnotation(methodConfig.getMethod(), ContentBlockViewAnnotation.class);

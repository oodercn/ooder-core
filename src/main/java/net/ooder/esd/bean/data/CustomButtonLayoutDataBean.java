...
import net.ooder.esd.custom.component.FullButtonLayoutComponent;
import net.ooder.web.util.AnnotationUtil;
@CustomClass(
        clazz = FullButtonLayoutComponent.class,
        viewType = CustomViewType.LISTMODULE,
        moduleType = ModuleViewType.BUTTONLAYOUTCONFIG
)
@AnnotationType(clazz = ButtonLayoutViewAnnotation.class)
public class CustomButtonLayoutDataBean extends CustomDataBean {
    ...
    public CustomButtonLayoutDataBean() {

    }


    public CustomButtonLayoutDataBean fillData(TitleBlockViewAnnotation annotation) {
        return AnnotationUtil.fillBean(annotation, this);
    }

    public CustomButtonLayoutDataBean(MethodConfig methodConfig) {
        super(methodConfig);

...
import net.ooder.esd.annotation.view.OpinionViewAnnotation;
import net.ooder.esd.bean.MethodConfig;
import net.ooder.annotation.AnnotationType;
import net.ooder.esd.custom.component.FullOpinionComponent;
import net.ooder.web.util.AnnotationUtil;
@CustomClass(clazz = FullOpinionComponent.class,
        viewType = CustomViewType.LISTMODULE,
        moduleType = ModuleViewType.OPINIONCONFIG
)
@AnnotationType(clazz = OpinionViewAnnotation.class)
public class CustomOpinionDataBean extends CustomDataBean {
    ...
    public CustomOpinionDataBean() {

    }


    public CustomOpinionDataBean fillData(OpinionViewAnnotation annotation) {
        return AnnotationUtil.fillBean(annotation, this);
    }

    public CustomOpinionDataBean(MethodConfig methodConfig) {
        super(methodConfig);
        OpinionViewAnnotation gridAnnotation = AnnotationUtil.getMethodAnnotation(methodConfig.getMethod(), OpinionViewAnnotation.class);

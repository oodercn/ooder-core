...
import net.ooder.esd.custom.component.FullGalleryComponent;
import net.ooder.web.util.AnnotationUtil;
@CustomClass(clazz = FullGalleryComponent.class,
        viewType = CustomViewType.LISTMODULE,
        moduleType = ModuleViewType.GALLERYCONFIG
)
@AnnotationType(clazz = GalleryViewAnnotation.class)
public class CustomGalleryDataBean extends CustomDataBean {
    ...
    public CustomGalleryDataBean() {

    }


    public CustomGalleryDataBean fillData(GalleryViewAnnotation annotation) {
        return AnnotationUtil.fillBean(annotation, this);
    }

    public CustomGalleryDataBean(MethodConfig methodConfig) {
        super(methodConfig);
        GalleryViewAnnotation gridAnnotation = AnnotationUtil.getMethodAnnotation(methodConfig.getMethod(), GalleryViewAnnotation.class);
